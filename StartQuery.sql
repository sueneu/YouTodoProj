...
CREATE TABLE Reward (
  ...
  RedemptionDate timestamp default null
);
...
GRANT EXECUTE ON FUNCTION createquestforpartymember(questname text, questdescription text, reward text, questsize text, targetuserid uuid) TO PUBLIC;
GRANT EXECUTE ON FUNCTION GetPartyAndUsers() TO PUBLIC;
